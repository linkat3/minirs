...
class CommunityLinkController extends Controller
{
    ...
    public function store(CommunityLinkForm $request)
    {
        ...
        if ($link->hasAlreadyBeenSubmitted()) {
            // If the link exists, return the appropriate response or redirect
            return redirect()->back()->with('info', 'The link already exists. Please check the list.');
        }

        // If the link is new, save it to the database
        $link->save();
    }
